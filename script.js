...
var T = {
  en: {
    ...
    "mq.tennis": "Tennis",
    "mq.mma": "MMA & Combat Sports",
    "mq.athletics": "Athletics",
    "mq.swimming": "Swimming",
    "mq.volleyball": "Volleyball",
    "mq.esports": "eSports",
    "mq.golf": "Golf",
    "mq.surfing": "Surfing",
    "mq.f1": "F1 & Motorsport",
    "mq.rugby": "Rugby",
    "mq.cricket": "Cricket",
    "mq.baseball": "Baseball",
    "prob.label": "The Problem",
    "prob.title":
      'A <span class="text-red-400/80">$500B+ Industry</span>,<br>Digitally Broken',
    "prob.desc":
      "The global sports market moves hundreds of billions of dollars annually. Yet, there's no dominant digital platform connecting all the players in this ecosystem efficiently. The result? Chaos, fragmentation, and lost opportunities — every single day.",
    "prob.c1t": "Athletes Can't Showcase Their Potential",
    "prob.c1d":
      "Talent gets buried under memes, ads, and irrelevant content on generic platforms. No dedicated space exists for athletes to build a professional sports portfolio.",
    "prob.c2t": "No Qualified Networking Exists",
    "prob.c2d":
      "Agents, scouts, and clubs struggle to find the right connections. Traditional networks offer noise, not signal — making qualified networking nearly impossible.",
    "prob.c3t": "Fragmented Ecosystem",
    "prob.c3d":
      "Information, services, and opportunities are scattered across dozens of platforms, WhatsApp groups, and spreadsheets. There's no single source of truth.",
    "prob.c4t": "Opportunities Lost Daily",
    "prob.c4d":
      "Sponsorships, transfers, partnerships, and deals slip through the cracks because the right people never find each other at the right time.",
    ...
    "mkt.desc":
      "Sports is one of the biggest industries on the planet — yet it remains dramatically underexplored digitally. The gap between the industry's size and its digital infrastructure is Novitch's opportunity.",
    "mkt.s1l": "Global Sports Industry",
    "mkt.s1d":
      "Annual revenue across all sports verticals — and growing faster than ever.",
    "mkt.s2l": "Sports Professionals",
    "mkt.s2d":
      "Coaches, agents, managers, physios, and other professionals globally.",
    "mkt.s3l": "Sports Fans Worldwide",
    "mkt.s3d":
    ...
    "ft.cl": "Company",
    "ft.cu": "Contact Us",
    "ft.cp": "© 2026 Novitch. All rights reserved.",
  },
  "pt-br": {
    ...
    "mq.tennis": "Tênis",
    "mq.mma": "MMA e Lutas",
    "mq.athletics": "Atletismo",
    "mq.swimming": "Natação",
    "mq.volleyball": "Vôlei",
    "mq.esports": "eSports",
    "mq.golf": "Golfe",
    "mq.surfing": "Surfe",
    "mq.f1": "F1 e Automobilismo",
    "mq.rugby": "Rugby",
    "mq.cricket": "Críquete",
    "mq.baseball": "Beisebol",
    "prob.label": "O Problema",
    "prob.title":
      'Uma <span class="text-red-400/80">Indústria de $500B+</span>,<br>Digitalmente Quebrada',
    "prob.desc":
    ...
    "mkt.desc":
      "O esporte é uma das maiores indústrias do planeta — e ainda permanece dramaticamente subexplorado digitalmente. A lacuna entre o tamanho da indústria e sua infraestrutura digital é a oportunidade da Novitch.",
    "mkt.s1l": "Indústria Esportiva Global",
    "mkt.s1d":
      "Receita anual em todos os segmentos esportivos — crescendo mais rápido do que nunca.",
    "mkt.s2l": "Profissionais do Esporte",
    "mkt.s2d":
      "Técnicos, agentes, gestores, fisioterapeutas e outros profissionais globalmente.",
    ...
    "feat.label": "Funcionalidades da Plataforma",
    "feat.title":
    ...
    "ft.cl": "Empresa",
    "ft.cu": "Fale Conosco",
    "ft.cp": "© 2026 Novitch. Todos os direitos reservados.",
  },
};
